...
class CloakEmail
{
    public static $mode                    = 'simple';
    public static $convert_page_content    = false;
    public static $template_insert_links    = false;
    public static $page_insert_links        = false;
    public static $at                        = ' at ';
    public static $dot                        = ' dot ';
    public static $hard_noscript_error        = 'JavaScript must be turned on in order to see this email address.';
